...
public class FishBasket extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvFishBackToCatalog.setOnClickListener(view14 -> {
        ...
        lvShopBasket.setOnItemLongClickListener((adapterView, view13, i, l) -> {
            ...
            btnDeleteCancel.setOnClickListener(view12 -> dialogDeleteItem.dismiss());
            Button btnDeleteItem = dialogDeleteItem.findViewById(R.id.ok_btn_dialog_deleteItem);
            btnDeleteItem.setOnClickListener(view1 -> {
